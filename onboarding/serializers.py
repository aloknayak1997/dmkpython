...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = DpyUsers
        fields = ('id', 'first_name', 'middle_name', 'last_name', 'email', 'mobile', 'image', 'password','dob','gender','blood_group','religion','caste','nationality','place_of_birth','address','address2')
        extra_kwargs = {
