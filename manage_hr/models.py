...
class DpyLeaveTypes(models.Model):
    ...
    emp = models.ForeignKey(DpyEmployee, models.PROTECT)
    institute = models.ForeignKey(DpyInstituteUsers, models.PROTECT)
    leave_name = models.IntegerField(db_column='Leave_name')  # Field name made lowercase.
