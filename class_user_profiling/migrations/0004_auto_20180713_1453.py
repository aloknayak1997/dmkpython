...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL("ALTER TABLE dpy_institute_class_user_presenties CHANGE `status` `status` tinyint(1) unsigned NOT NULL DEFAULT '1' AFTER `marked_by`"),
        migrations.RunSQL("ALTER TABLE dpy_institute_class_user_presenties CHANGE `created_on` `created_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP AFTER `status`"),
        migrations.RunSQL("ALTER TABLE dpy_institute_class_user_presenties CHANGE `updated_on` `updated_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP AFTER `created_by`"),
    ]
